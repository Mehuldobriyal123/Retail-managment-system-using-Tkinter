...
root.title('Retail Management System created by Mehul dobriyal')
...
labelTitle = Label(topFrame, text='Retail Management System', font=('arial', 30, 'bold'), fg='yellow', bd=9,
                   bg='red4', width=51)
